...
class ApplyInvalidDiscountCodeTest extends TestCase
{
    /**
     * A basic feature test example.
     */
    public function test_to_apply_invalid_discount(): void
    { // register a user
        $response = $this->post('/register', [
            'email' => 'applyinvaliddiscount@email.com',
            'password' => 'TestTest1',
        ]);
        ...
        $response->assertSessionHas('error', 'The discount code is invalid');
        ...
        $response = $this->get('/remove_from_basket/3');
        $response->assertStatus(302);
