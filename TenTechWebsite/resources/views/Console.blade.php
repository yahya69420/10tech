...
<!--
         <div class="categories-section">
          <div class="category">
            <a href="laptop.php">
              <div class="image">
                  <img src="console1.png" alt="Product 1">
              </div>
        ...
        <div class="sorts_filter-section"> 
            ...
            <div class="dropdownSF" style="margin-left: 10px;">
                ...
                <div id="releaseDropdown" class="dropdown-contentSF">
                    @php
                        $uniqueReleases = $consoles->unique('release')->sortBy('release');
                    @endphp
                    @foreach ($uniqueReleases  as $console)
                        <a href="?release={{ $console->release }}&sort={{ $currentSort }}&brand={{ $currentBrand }}">{{ $console->release }}</a>
                    @endforeach
            ...
            <div class="dropdownSF" style="margin-left: 10px;"> <!-- Adding some space -->
                ...
                <div id="brandDropdown" class="dropdown-contentSF">
                    @php
                        $uniqueBrands = $consoles->unique('brand')->sortBy('brand');
                    @endphp
                    @foreach ($uniqueBrands  as $console)
                        <a href="?brand={{ $console->brand }}&sort={{ $currentSort }}&release={{ $currentRelease }}">{{ $console->brand }}</a>
                    @endforeach
        ...
        @endforeach
          ...
          <!-- <div class="category">
            <a class="link1" href="Mobile">
                <div class="image">
                    <img src="console2.png" alt="Product 1">
                </div>
                <div class="product-details">
                    <h3>Console 2</h3>
                    <p>$109.99</p>
          ...
          <div class="category">
            <a href="">
              <div class="image">
                  <img src="console3.png" alt="Product 1">
                </div>
              <div class="product-details">
                  <h3>Console 3</h3>
                  <p>$199.99</p>
          ...
          <div class="category">
            <a href="" >
              <div class="image">
                  <img src="console4.png" alt="Product 1">
              </div>
              <div class="product-details">
                  <h3>Console 4</h3>
                  <p>$199.99</p>
          ...
          <div class="category">
            <a href="" >
              <div class="image">
                  <img src="console5.png" alt="Product 1">
              </div>
              <div class="product-details">
                  <h3>Console 5</h3>
                  <p>$199.99</p>
