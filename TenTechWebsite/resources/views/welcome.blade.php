    ...
    <head>
        ...
        <style>
           ...
           #carouselss {
            ...
            .carousel-item {
                 height: 400px; /* Set the desired height for your carousel item */
            }
          ...
          /* Set the background image for the first carousel item */
          ...
          .our-product {
            ...
            font-size: 36px; /* Larger font size for "Our Product" */
            font-weight: bold;
        }
        .affordable-cutting-edge {
          text-align: center;
            font-size: 24px; /* Larger font size for "Affordable & Cutting Edge" */
          }
            ...
            <div id="carousels" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="pexels-format-1029757.jpg" alt="First slide">
                </div>
