    ...
    <body>
      @include('header')
          ...
          <div class="sorts_filter-section"> 
            ...
            <div class="dropdownSF" style="margin-left: 10px;">
                ...
                <div id="releaseDropdown" class="dropdown-contentSF">
                    @php
                        $uniqueReleases = $monitors->unique('release')->sortBy('release');
                    @endphp
                    @foreach ($uniqueReleases  as $monitor)
                        <a href="?release={{ $monitor->release }}&sort={{ $currentSort }}&brand={{ $currentBrand }}">{{ $monitor->release }}</a>
                    @endforeach
            ...
            <div class="dropdownSF" style="margin-left: 10px;"> <!-- Adding some space -->
                ...
                <div id="brandDropdown" class="dropdown-contentSF">
                    ...
                    @php
                        $uniqueBrands = $monitors->unique('brand')->sortBy('brand');
                    @endphp
                    @foreach ($uniqueBrands  as $monitor)
                        <a href="?brand={{ $monitor->brand }}&sort={{ $currentSort }}&release={{ $currentRelease }}">{{ $monitor->brand }}</a>
                    @endforeach
        ...
        <div class="category">
            ...
            <div class="image">
              <img src="{{ $monitor->image }}" alt="{{ $monitor->image }}">
            </div>
            <div class="product-details">
                <h3>{{ $monitor->name }}</h3>
                <p>£{{ $monitor->price }}</p>
