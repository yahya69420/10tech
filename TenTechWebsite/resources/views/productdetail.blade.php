...
<body>
            ...
            <div class="col-lg-7 col-md-12 col-12">
                <div class="product-details">
                    ...
                    <div class = "rating">
                        ...
                        @for($i = 1; $i<= $ratenum; $i++ )
                            <i class = "fa fa-star checked"></i> <!-- Display a filled star for each point in the average rating -->
                        @endfor
                        <!-- Generate empty stars for the remainder up to 5 -->
                        @for($j = $ratenum+1; $j <= 5; $j++ )
                            <i class = "fa fa-star "></i> <!-- Display an empty star for each point missing to reach 5 -->
                        @endfor
    ...
    <!-- This part of the code displays the model for ratings and reviews using sweet alerts -->
